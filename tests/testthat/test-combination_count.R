test_that("multiplication works", {
  ...
  expect_error(combination_count(3.5, 30))
  expect_error(combination_count(3, 10.3))
  expect_error(combination_count(-5, 2))
  expect_error(combination_count(10, -1))
  expect_error(combination_count(100, 101))
})
